...
syn region cssPseudoClassFn contained matchgroup=cssFunctionName start=":\(not\|lang\|\(nth\|nth-last\)-\(of-type\|child\)\)(" end=")" contains=cssStringQ,cssStringQQ,cssPseudoClassId,cssValueInteger
" ------------------------------------
